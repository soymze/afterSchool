...
public class Kareler extends JPanel implements MouseListener,MouseMotionListener{
	...
	public void mouseDragged(MouseEvent e) {
		...
		else if(seciliKare !=null) {
		seciliKare.setSize((int)(e.getX()-seciliKare.getX()), (int)(e.getY()-seciliKare.getY()));
		repaint();
		}
		tasi=false;
		if(sagAlt != null && sagAlt.contains(e.getPoint())){
			return;
		}
		else if(sagUst != null && sagUst.contains(e.getPoint())){
			return;
		}
		else if(solAlt != null && solAlt.contains(e.getPoint())){
			return;
		}
		else if(solUst != null && solUst.contains(e.getPoint())){
			return;
		}
	}
